...
class OpenIDConnectClient {
	 ...
	 *        	encoded JWT
	 * @param int $section
	 *        	the section we would like to decode
	 * @return object
	 */
	...
	public function requestUserInfo($attribute) {
		...
		$user_info_endpoint .= "?schema=" . $schema . "&access_token=" . $this->accessToken;
	 ...
	 *        	string If this is set the post type will be POST
	 * @throws OpenIDConnectClientException
	 * @return mixed
	 */
